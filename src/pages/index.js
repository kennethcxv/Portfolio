...
export default function Home() {
  ...
  return (
    ...
    <main className="flex justify-center items-center w-full min-h-screen bg-white dark:bg-black">
      ...
      {/* Content on the right */}
        <div className="w-3/5 text-center">
          ...
          <p className="my-6 text-lg md:text-2xl lg:text-3xl font-medium mr-44 text-dark dark:text-light">
          ...
          className="bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light md:p-2 md:px-4 md:text-base">
              Resume
            </Link>
