...
export default function Home() {
  ...
  return (
    ...
    <main className="flex justify-center xl:w-full xl:items-start items-center w-full min-h-screen bg-white dark:bg-black">
  
        {/* Sphere Tag Cloud on the left */}
      <div className="xl:w-full w-1/2 2xl:ml-10 sm:block">
        <SphereTagCloud />
      </div>
      {/* Content on the right */}
      <div className="w-3/5 text-center  xl:w-full xl:text-center xl:ml-10 xl:mr-10 xl:text-md">
        <h1 className="text-5xl 2xl:text-[40px] 2xl:mr-20 font-semibold text-dark xl:mr-10 xl:ml-10 mr-44 dark:text-light">
          <Typewriter
              options={{
                strings: [
          ...
          <p 
          className="my-6 xl:mr-96 xl:w-full 2xl:mr-20
          xl:bg-green-500 sm:text-sm md:text-md xl:align-top xl:full xl:ml-10  xl:text-xl lg:text-lg  2xl:text-lg 2xl:ml-5 2xl:mb-60  text-lg font-medium mr-44 text-dark dark:text-light">
